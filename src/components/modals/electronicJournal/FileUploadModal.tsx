...
export default function FileUploadModal({ onClose, onFileSelect, title = "Upload Document" }: FileUploadModalProps) {
        ...
        {!previewImage ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 text-center">
              Choose how you'd like to add your document image
            </p>
          </div>
        ) : (
          <div>
